...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileEntry._filesize'
        db.add_column(u'cosinnus_file_fileentry', '_filesize',
                      self.gf('django.db.models.fields.IntegerField')(default=u'0', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileEntry._filesize'
        db.delete_column(u'cosinnus_file_fileentry', '_filesize')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cosinnus_file_fileentry', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'FileEntry.media_tag'
        db.alter_column(u'cosinnus_file_fileentry', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.SET_NULL))

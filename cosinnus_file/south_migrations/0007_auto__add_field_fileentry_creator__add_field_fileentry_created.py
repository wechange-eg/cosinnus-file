...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileEntry.creator'
        db.add_column(u'cosinnus_file_fileentry', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_file_fileentry_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'FileEntry.created'
        db.add_column(u'cosinnus_file_fileentry', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileEntry.creator'
        db.delete_column(u'cosinnus_file_fileentry', 'creator_id')

        # Deleting field 'FileEntry.created'
        db.delete_column(u'cosinnus_file_fileentry', 'created')
    ...
    models = {
        ...
        u'cosinnus_file.fileentry': {
            'Meta': {'ordering': "[u'-uploaded_date', u'title']", 'object_name': 'FileEntry'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field attached_objects on 'FileEntry'
        m2m_table_name = db.shorten_name(u'cosinnus_file_fileentry_attached_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('fileentry', models.ForeignKey(orm[u'cosinnus_file.fileentry'], null=False)),
            ('attachedobject', models.ForeignKey(orm[u'cosinnus.attachedobject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['fileentry_id', 'attachedobject_id'])


    def backwards(self, orm):
        # Removing M2M table for field attached_objects on 'FileEntry'
        db.delete_table(db.shorten_name(u'cosinnus_file_fileentry_attached_objects'))

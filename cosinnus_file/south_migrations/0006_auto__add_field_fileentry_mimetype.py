...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileEntry.mimetype'
        db.add_column(u'cosinnus_file_fileentry', 'mimetype',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileEntry.mimetype'
        db.delete_column(u'cosinnus_file_fileentry', 'mimetype')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FileEntry.uploaded_by'
        db.delete_column(u'cosinnus_file_fileentry', 'uploaded_by_id')

        # Deleting field 'FileEntry.uploaded_date'
        db.delete_column(u'cosinnus_file_fileentry', 'uploaded_date')


    def backwards(self, orm):
        # Adding field 'FileEntry.uploaded_by'
        # get any valid user id, will be overwritten by 0008 migration anyway
        valid_user_id = orm['auth.User'].objects.all()[0].id
        db.add_column(u'cosinnus_file_fileentry', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=valid_user_id, related_name=u'files', on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'FileEntry.uploaded_date'
        db.add_column(u'cosinnus_file_fileentry', 'uploaded_date',
    ...
    models = {
        ...
        u'cosinnus_file.fileentry': {
            'Meta': {'ordering': "[u'-created', u'title']", 'object_name': 'FileEntry'},

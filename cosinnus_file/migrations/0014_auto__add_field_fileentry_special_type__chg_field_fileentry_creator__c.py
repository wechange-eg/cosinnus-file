...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileEntry.special_type'
        db.add_column(u'cosinnus_file_fileentry', 'special_type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=8, null=True, blank=True),
                      keep_default=False)

        # Changing field 'FileEntry.creator'
        db.alter_column(u'cosinnus_file_fileentry', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'FileEntry.special_type'
        db.delete_column(u'cosinnus_file_fileentry', 'special_type')

        # Changing field 'FileEntry.creator'
        db.alter_column(u'cosinnus_file_fileentry', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['auth.User']))
    ...
    models = {
        ...
        u'cosinnus_file.fileentry': {
            ...
            '_filesize': ('django.db.models.fields.IntegerField', [], {'default': "u'0'", 'null': 'True', 'blank': 'True'}),
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_file_fileentry_set'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_file_fileentry_set'", 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'special_type': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '8', 'null': 'True', 'blank': 'True'}),

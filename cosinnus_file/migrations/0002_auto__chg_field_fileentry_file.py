...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'file_fileentry', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'FileEntry.file'
        db.alter_column(u'file_fileentry', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
